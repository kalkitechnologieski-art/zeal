...
-- CreateEnum
CREATE TYPE "ConsultantCategory" AS ENUM ('ASTROLOGER', 'PSYCHOLOGIST', 'TAROT', 'NUMEROLOGIST', 'PALMIST', 'VASTU', 'REIKI', 'LIFE_COACH', 'HEALER', 'MOTIVATIONAL_SPEAKER', 'SPIRITUAL_GUIDE', 'YOGA_INSTRUCTOR');
...
-- CreateIndex
CREATE UNIQUE INDEX "AIConsultant_username_key" ON "AIConsultant"("username");
...
-- AddForeignKey
ALTER TABLE "UserActivity" ADD CONSTRAINT "UserActivity_consultantId_fkey" FOREIGN KEY ("consultantId") REFERENCES "Consultant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CallSession" ADD CONSTRAINT "CallSession_aiConsultantId_fkey" FOREIGN KEY ("aiConsultantId") REFERENCES "AIConsultant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
