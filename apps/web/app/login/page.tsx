...
function LoginForm() {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    if (isSignUp) {
      ...
      if (error) {
        ...
        // HARD NAVIGATION: Bypasses Next.js cache to guarantee proxy reads new cookies
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-indigo-100">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <Link href="/">
          <h2 className="text-4xl font-black text-gray-900 tracking-tighter hover:text-indigo-600 transition-colors flex items-center justify-center gap-2">
            <span className="w-3 h-3 rounded-full bg-indigo-600 inline-block"></span> ZEAL.
          </h2>
        </Link>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-2xl shadow-gray-200/50 sm:rounded-[2rem] sm:px-10 border border-gray-100">
          
          <div className="flex p-1 mb-8 bg-gray-50 rounded-xl relative border border-gray-100">
            <button
          ...
          <form className="space-y-5" onSubmit={handleEmailAuth}>
            ...
            <button
              ...
              className="w-full flex justify-center items-center gap-2 py-3.5 px-4 border border-transparent rounded-2xl shadow-sm text-sm font-bold text-white bg-gray-900 hover:bg-gray-800 transition-all"
            >
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-6 w-full flex justify-center items-center gap-3 py-3.5 px-4 border-2 border-gray-100 rounded-2xl shadow-sm bg-white text-sm font-bold text-gray-700 hover:bg-gray-50 hover:border-gray-200 transition-all"
            >
