...
export default async function WhiteLabelServicesPage({ params }: PageProps) {
        ...
        {services.map((s) => (
          ...
          >
            ...
            <Link
              ...
              className="inline-block px-4 py-2 rounded-xl bg-[#9D7DC5]/10 text-[#9D7DC5] text-sm font-medium"
            >
              Book →
            </Link>
          </div>
