          ...
          >
              ...
              <div className="flex items-center gap-4">
                <Avatar className="w-12 h-12">
                  <AvatarImage
                    ...
                    alt={listing.user.name || listing.user.email}
                  />
                  <AvatarFallback>
                ...
                <div>
                  <p className="font-semibold text-[#5E4B8B]">{listing.user.name || listing.user.email}</p>
                  <p className="text-sm text-[#B8A1D9]">@{listing.user.email?.split("@")[0]}</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between mt-4 pt-4 border-t border-[#E1C5E7]">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-[#5E4B8B]">{listing.sparks.toLocaleString()} Sparks</span>
              </div>
              <Button variant="primary" onClick={() => onBid(listing.id)}>
                Place Bid
              </Button>
            </div>
          </div>
