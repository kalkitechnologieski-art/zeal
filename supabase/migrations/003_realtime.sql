-- ═══════════════════════════════════════════════════════════════════════════════
-- ZEAL — REALTIME PUBLICATION
-- ═══════════════════════════════════════════════════════════════════════════════
DO $$
DECLARE tbl TEXT;
DECLARE tables_to_publish TEXT[] := ARRAY['AIConsultant','Consultant','Booking','CallSession','Wallet','Transaction','Notification','Post','ChatMessage','Conversation'];
BEGIN
